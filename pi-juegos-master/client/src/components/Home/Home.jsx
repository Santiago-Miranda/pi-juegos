...
export default function Home (){
    ...
    <div className={style.hambur}>
        <div id={style.bar1}></div>
        <div id={style.bar2}></div>
        <div id={style.bar3}></div>
                ...
                <div className={style.card}>
                {
                    ...
                    <img src="https://i.pinimg.com/originals/af/11/4f/af114f7c569724a3cea1884cd1836404.png" alt="not found" />
                }
                </div>
                <div className={style.paginado_container}>
